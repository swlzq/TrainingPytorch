...
class Checkpoint(object):
    def __init__(self, result_path='./'):
        ...
        self.checkpoint_params = {'models': None, 'optimizer': None, 'epoch': None, 'best_result': None}
    ...
    def save_checkpoint(self, model, optimizer, scheduler, epoch, best_result):
        ...
        self.checkpoint_params['models'] = model.state_dict()
    ...
    def save_state_dict(self, model, save_name='models', best_flag=False):
        '''
        :param model:
    ...
    def load_checkpoint(self, checkpoint_file):
        if os.path.isfile(checkpoint_file):
            print('==> Load checkpoints from {}'.format(checkpoint_file))
            self.checkpoint_params = torch.load(checkpoint_file)
            model_state_dict = self.checkpoint_params['models']
